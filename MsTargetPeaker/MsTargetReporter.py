...
def main():
  ...
  parser.add_argument('--chromatogram_fig_w', '-figw', type=float, default=None, help="The figure width in inches. Only works when --output_chromatogram_pdf is set. (default: ncol * 7.0)")
  parser.add_argument('--chromatogram_fig_h', '-figh', type=float, default=None, help="The figure height in inches. Only works when --output_chromatogram_pdf is set. (default: nrow * 5.0)")
